...
1. The JupyterNotebook is climate_starter
2. The DevelopersNotebookwApp is the JupyterNotebook that was used for purposes of creating the Flask app.  However, once completed and tested, it was moved to app.py
3. The Flask app is app.py
4. Copy of images generated by the Jupyter Notebook are in the images folder
5. None of the bonus material was completed for this homework
